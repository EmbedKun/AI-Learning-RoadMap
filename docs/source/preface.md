...
```{figure} _static/AI-learning-flow-diagram.png
:alt: The Big Picture
:align: center
:width: 72%

The full learning journey, from foundations to models, systems, infrastructure, and applications.
```

```{figure} _static/AI-five-layer-stack.png
:alt: AI Five-layer Stack
:align: center
:width: 72%
